(() => {
  ...
  const modeConfigs = {
    home: { colors: [[200,169,110],[138,143,160],[224,206,170]], centers:[{x:0.28,y:0.2,r:0.72},{x:0.7,y:0.45,r:0.62},{x:0.45,y:0.75,r:0.58}]},
    weekly: { colors: [[200,169,110],[138,143,160],[224,206,170]], centers:[{x:0.2,y:0.3,r:0.7},{x:0.68,y:0.5,r:0.64},{x:0.5,y:0.78,r:0.56}]},
    lunar: { colors: [[200,169,110],[138,143,160],[224,206,170]], centers:[{x:0.24,y:0.22,r:0.74},{x:0.74,y:0.48,r:0.6},{x:0.44,y:0.76,r:0.62}]},
    signals: { colors: [[200,169,110],[138,143,160],[224,206,170]], centers:[{x:0.2,y:0.25,r:0.7},{x:0.72,y:0.42,r:0.6},{x:0.5,y:0.8,r:0.58}]},
    network: { colors: [[200,169,110],[138,143,160],[224,206,170]], centers:[{x:0.22,y:0.24,r:0.72},{x:0.7,y:0.5,r:0.6},{x:0.48,y:0.78,r:0.6}]},
  };
